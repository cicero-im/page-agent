 ...
 */
export function AdaptiveIcon({ icon: Icon, ...props }: { icon: React.FC<IconProps> } & IconProps) {
...
export const BracketLeftIcon: React.FC<IconProps> = (props) => (
	<svg fill="currentColor" viewBox="0 0 4096 4096" xmlns="http://www.w3.org/2000/svg" {...props}>
