...
export default function HeroSection() {
	...
	const [activeTab, setActiveTab] = useState<"try" | "other">(
		isOther ? "other" : "try",
	);
			...
			win.pageAgent = new (PageAgent as typeof PageAgentType)({
				...
				instructions: {
					...
					getPageInstructions: (url: string) => {
						return url.includes("page-agent")
							? "This is PageAgent demo page."
							: undefined;
					},
				},
	...
	return (
		<section
			className="relative px-6 pt-18 pb-14 lg:pb-20 lg:pt-24"
										...
										<div className="space-y-4">
											...
											<p className="text-xs text-gray-500 dark:text-gray-400 text-left">
												{isZh ? (
													...
													<>
														Powered by free testing LLM API. By clicking Run you
														agree to the{" "}
														<a
															href="https://github.com/arthrod/page-agent/blob/main/docs/terms-and-privacy.md#2-testing-api-and-demo-disclaimer--terms-of-use"
															target="_blank"
												...
												<div className="bg-green-50 dark:bg-gray-700 p-4 rounded-lg">
													...
													<div className="flex items-center justify-center gap-3">
														<select
															...
															onChange={(e) =>
																setCdnSource(
																	e.target.value as "international" | "china",
																)
															}
												...
												<ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
													<li className="flex items-start text-left">
														...
														{isZh ? (
															...
															<span>
																Uses free testing LLM API. By using you agree to
																the{" "}
																<a
																	href="https://github.com/arthrod/page-agent/blob/main/docs/terms-and-privacy.md#2-testing-api-and-demo-disclaimer--terms-of-use"
																	target="_blank"
