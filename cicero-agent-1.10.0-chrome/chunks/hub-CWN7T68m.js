import { A as require_react, O as createLucideIcon, S as Square, _ as Button, c as StatusDot, d as EventCard, f as useAgent, g as ErrorBoundary, i as Switch, j as __toESM, k as require_client, o as Logo, r as isHubTokenAuthorized, s as MotionOverlay, u as ActivityCard, v as require_jsx_runtime, w as FoldVertical, x as UnfoldVertical } from "./assets-BGDcqUVn.js";
/**
...
var HubWs = class {
	...
	async #checkApproval(token) {
		if (this.#approved) return true;
		if (isHubTokenAuthorized((await chrome.storage.local.get("PageAgentExtHubToken"))["PageAgentExtHubToken"], token)) {
			this.#approved = true;
			return true;
		}
